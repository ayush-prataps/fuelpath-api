...
| 2 | **500-mile range**, **10 mpg** → 50-gallon tank | Fixed to the assessment assumptions; encapsulated in the `VehicleConfig` dataclass so no magic numbers exist in solver code |
